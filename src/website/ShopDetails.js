...
const ShopDetails = {
    async render() {
        ...
        const resultProducts = await relate.map((products) => {
            return /*html */ `
                <div class="col-lg-3 col-md-4 col-sm-6">
                    <div class="product__item">
                        ...
                        <div class="product__item__text">
                            ...
                            <h5>$ ${new Intl.NumberFormat("en-IN", {maximumSignificantDigits: 3,}).format(products.price)}</h5>
                        </div>
                    </div>
                </div>
            `
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="product__details__text">
                                ...
                                <div class="product__details__price">$${new Intl.NumberFormat("en-IN",{ maximumSignificantDigits: 3 }).format(products.price)}</div>
                                ...
                                <button class="primary-btn" id="addToCart" style="border:none;">ADD TO CART</button>
    ...
    async afterRender() {
        ...
        $("#addToCart").addEventListener("click", () => {
            let cartProQtt = localStorage.getItem("cartProQtt");
            let cartNumber = $("#cartNumber");
            cartProQtt = parseInt(cartProQtt);
            if(cartProQtt){
                localStorage.setItem("cartProQtt", cartProQtt + 1);
                cartNumber.innerHTML = cartProQtt;
            }else{
                localStorage.setItem("cartProQtt", 1)
                cartNumber.innerHTML = cartProQtt;
            }
        ...
        function totalPrice(product){
            ...
            if(totalPrice != null){
                ...
                localStorage.setItem("totalPrice", totalPrice + parseInt(product.price));
            }else{
