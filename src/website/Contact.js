...
const Contact = {
                        ...
                        <form id="form-add-contact">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <input type="text" id="nameContact" placeholder="Your name">
                                </div>
                                <div class="col-lg-6 col-md-6">
                                    <input type="text" id="emailContact" placeholder="Your Email">
                                </div>
                                <div class="col-lg-12 text-center">
                                    <textarea placeholder="Your message" id="messageContact"></textarea>
    ...
    async afterRender(){
        $("#form-add-contact").addEventListener("submit", (e) => {
            const nameC = $("#nameContact").value;
            const emailC = $("#emailContact").value;
            const messageC = $("#messageContact").value;
              e.preventDefault();
                const contact = {
